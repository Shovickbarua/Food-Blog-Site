...
<body>
  ...
  <div class="content-wrapper bg-white">
      ...
      <div class="row pad ">
          ...
          <div class="col-md-3 d-inline-block p-3 ">
            <img class="img-fluid photo1" src="images/photo5.jpg" >
              <p>
              <h4 class="col "><a href="buy2.php">Tuna Curry</a></h4>
              </p>
              <p class="pl-2 tt">
              <span class="textplus"><b>Price: $29</b></span></br>
              Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC  </br>
              <span class="fa fa-star checked"></span>
              <span class="fa fa-star checked"></span>
              <span class="fa fa-star checked"></span>
    ...
    <div class="container">
        <div class="row mt-5 mb-5 pad2">
          <div class="col-md-6 pt-2 pl-3 pr-3">
            <img class="img-fluid shad " src="images/cupcake.jpg" >
          </div>
          <div class="col-md-6 pl-2 pr-2 ">
          <p>
              <h4 class="col2">Strawberry Cupcakes</h4>
              <p class="bod"></p>
          </P>
          <p class="tt">
      ...
      <div class="container">
        <div class="row mt-5 pb-5 pad2">
          ...
          <div class="col-md-6 pl-4 pr-4 mt-3">
            <img class="img-fluid shad" src="images/cook10.jpg" >
          </div>
        </div>
      </div>
